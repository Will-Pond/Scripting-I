...
def list_dir_contents(dir_name, log_file="", dirs_only=False) -> None:    # The list_dir_contents gets the contents of the direct and list it
...
parser = ap.ArgumentParser(prog="DISPLAY_DIR_CONTENTS", add_help=True, usage="./test.py [-i, -h, -d] [DIR_PATH]", description="This programs list the contents of a directory base on the options")
...
#DIR_PATH argument
parser.add_argument("DIR_PATH", action="store", help="Gets the path of the directory from which files needed to be listed")
